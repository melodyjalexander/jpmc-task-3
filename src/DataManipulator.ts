...
export interface Row {
  ...
  // Melody's Notes --- Updated schema to match schema changes made in graph
}
...
export class DataManipulator {
  ...
  // Melody's Notes --- Updated function that generates the row to process data from the server, and reflects the desired ratio constraints
}
